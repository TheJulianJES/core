...
class CarbonMonoxideConcentrationConverter(BaseUnitConverter):
    ...
    _UNIT_CONVERSION: dict[str | None, float] = {
        CONCENTRATION_PARTS_PER_TRILLION: 1e12,
        ...
        CONCENTRATION_NANOGRAMS_PER_CUBIC_METER: (
            _CARBON_MONOXIDE_MOLAR_MASS / _AMBIENT_IDEAL_GAS_MOLAR_VOLUME * 1e9
        ),
    }
    VALID_UNITS = {
        CONCENTRATION_PARTS_PER_TRILLION,
...
class MassVolumeConcentrationConverter(BaseUnitConverter):
    ...
    _UNIT_CONVERSION: dict[str | None, float] = {
        CONCENTRATION_NANOGRAMS_PER_CUBIC_METER: 1_000_000_000.0,  # 1000 ng/m³ = 1 µg/m³
...
class NitrogenDioxideConcentrationConverter(BaseUnitConverter):
    ...
    _UNIT_CONVERSION: dict[str | None, float] = {
        ...
        CONCENTRATION_NANOGRAMS_PER_CUBIC_METER: (
            _NITROGEN_DIOXIDE_MOLAR_MASS / _AMBIENT_IDEAL_GAS_MOLAR_VOLUME * 1e9
        ),
    }
    VALID_UNITS = {
        CONCENTRATION_PARTS_PER_TRILLION,
...
class NitrogenMonoxideConcentrationConverter(BaseUnitConverter):
    ...
    _UNIT_CONVERSION: dict[str | None, float] = {
        ...
        CONCENTRATION_NANOGRAMS_PER_CUBIC_METER: (
            _NITROGEN_MONOXIDE_MOLAR_MASS / _AMBIENT_IDEAL_GAS_MOLAR_VOLUME * 1e9
        ),
    }
    VALID_UNITS = {
        CONCENTRATION_PARTS_PER_TRILLION,
...
class OzoneConcentrationConverter(BaseUnitConverter):
    ...
    _UNIT_CONVERSION: dict[str | None, float] = {
        ...
        CONCENTRATION_NANOGRAMS_PER_CUBIC_METER: (
            _OZONE_MOLAR_MASS / _AMBIENT_IDEAL_GAS_MOLAR_VOLUME * 1e9
        ),
    }
    VALID_UNITS = {
        CONCENTRATION_PARTS_PER_TRILLION,
...
class SulphurDioxideConcentrationConverter(BaseUnitConverter):
    ...
    _UNIT_CONVERSION: dict[str | None, float] = {
        ...
        CONCENTRATION_NANOGRAMS_PER_CUBIC_METER: (
            _SULPHUR_DIOXIDE_MOLAR_MASS / _AMBIENT_IDEAL_GAS_MOLAR_VOLUME * 1e9
        ),
    }
    VALID_UNITS = {
        CONCENTRATION_PARTS_PER_TRILLION,
...
class UnitlessRatioConverter(BaseUnitConverter):
    ...
    _UNIT_CONVERSION: dict[str | None, float] = {
        None: 1,
        CONCENTRATION_PARTS_PER_TRILLION: 1000000000000,
